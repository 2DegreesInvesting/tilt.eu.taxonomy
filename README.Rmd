...
2. Clarify whether market activities can be eligible for EU Taxonomy activities starting
   with “Manufacture of…”? 
3. TBC how to validate “maybe” from GPT validation.
4. Expand to all EU Taxonomy activities.
5. Company-level results output share of products that are aligned, not aligned, NA,  
